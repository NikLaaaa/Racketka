(()=> {
  ...
  function onRoundStart(d){
    ...
    // НОВОЕ: используем duration от сервера, чтобы не зависеть от часов клиента
  ...
  const WSTATE = { stars: 250, price: 50, sectors: [], angle: 0, spinning: false, rerollOnce:false };
